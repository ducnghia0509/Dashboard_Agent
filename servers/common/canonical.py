...
CANONICAL_KINDS = {
    "KQKD": ["kqkd", "hqkd", "bckqkd", "bao cao ket qua kinh doanh", "ket qua hoat dong kinh doanh"],
    ...
    "TSCD": ["tscd", "tai san co dinh", "tai san", "khau hao", "bieu khau hao"],
    ...
    "TONKHO": ["ton kho", "hang ton kho", "hang hoa"],
    "THUE": ["thue"],
    "DAUTU": ["dau tu"],
    "KDVH": ["ban xe", "kdvh"],
}
